...
func (x *ListTodosResponse) GetTotalPages() int32 {
	if x != nil {
		return x.TotalPages
	}
	return 0
...
const file_todo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"todo.proto\x12\x04todo\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe2\x01\n" +
	"\x04Todo\x12\x0e\n" +
	...
	".todo.Todo\x12=\n" +
	"\n" +
	"DeleteTodo\x12\x17.todo.DeleteTodoRequest\x1a\x16.google.protobuf.EmptyB\x1cZ\x1agrpc-todo/proto_gen;todopbb\x06proto3"
...
var file_todo_proto_depIdxs = []int32{
	...
	2, // 4: todo.TodoService.GetTodo:input_type -> todo.GetTodoRequest
	3, // 5: todo.TodoService.ListTodos:input_type -> todo.ListTodosRequest
	...
	4, // 10: todo.TodoService.ListTodos:output_type -> todo.ListTodosResponse
